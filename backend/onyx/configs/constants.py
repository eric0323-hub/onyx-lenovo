...
ONYX_DEFAULT_APPLICATION_NAME = "LKnow"
LEGACY_DEFAULT_APPLICATION_NAME = "Onyx"
...
# Messages
DISABLED_GEN_AI_MSG = (
    "Your System Admin has disabled the Generative AI functionalities of LKnow.\n"
    "Please contact them if you wish to have this enabled.\n"
    "You can still use LKnow as a search engine."
)
