...
def _format_messages_as_context(
    ...
    for msg in messages:
        ...
        sender = (
            "LKnowBot" if msg.author.id == bot_user.id else f"@{msg.author.display_name}"
        )
    ...
    return (
        "You are a Discord bot named LKnowBot.\n"
...
async def send_response(
    ...
    if isinstance(message.channel, discord.Thread):
        ...
        thread_name = f"LKnowBot <> {message.author.display_name}"[:100]
...
async def send_error_response(
    ...
    error_msg = "Sorry, I encountered an error processing your message. You may want to contact LKnow for support :sweat_smile:"
