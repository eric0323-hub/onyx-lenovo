...
export function Table<TData>(props: DataTableProps<TData>) {
  ...
  const isDraggableEnabled = hasDraggable && draggableReturn.isEnabled;
  ...
  function renderActiveDragOverlay(activeId: string) {
    const row = table
      .getRowModel()
  ...
  function renderDraggableScope(children: ReactNode) {
    if (!isDraggableEnabled) {
      return children;
    }

    const { dndContextProps, activeId } = draggableReturn;
    ...
    return (
      ...
      >
        ...
        <DragOverlay dropAnimation={null}>
          {activeId ? renderActiveDragOverlay(activeId) : null}
        </DragOverlay>
      </DndContext>
    );
  }
        ...
        >
          {renderDraggableScope(
            ...
            >
              ...
              <TableBody
                dndSortable={isDraggableEnabled ? draggableReturn : undefined}
              >
                ...
                {table.getRowModel().rows.map((row) => {
                  const rowId = isDraggableEnabled
