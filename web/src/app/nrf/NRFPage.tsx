...
export default function NRFPage({ isSidePanel = false }: NRFPageProps) {
  ...
  // If user toggles the "Use LKnow" switch to off, prompt a modal
          ...
          <Modal open={showTurnOffModal} onOpenChange={setShowTurnOffModal}>
            <Modal.Content width="sm">
              <Modal.Header
                ...
                title="Turn off LKnow new tab page?"
                description="You'll see your browser's default new tab page instead. You can turn it back on anytime in your LKnow settings."
      ...
      {!user && (
        <Modal open onOpenChange={() => {}}>
          <Modal.Content width="sm" height="sm">
            <Modal.Header icon={SvgUser} title="Welcome to LKnow" />
            <Modal.Body>
