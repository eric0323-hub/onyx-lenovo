...
export const ADMIN_ROUTES = {
  ...
  TAXONOMY: {
    path: "/admin/taxonomy/template-draft",
    icon: SvgBlocks,
    title: "标签体系",
    sidebarLabel: "标签体系",
  },
  TAXONOMY_TEMPLATE_DRAFT: {
    path: "/admin/taxonomy/template-draft",
    icon: SvgSparkle,
    title: "标签体系",
    sidebarLabel: "标签体系",
  ...
  TAXONOMY_SUMMARIES: {
    ...
    icon: SvgRefreshCw,
    title: "Summaries",
    sidebarLabel: "Summaries",
  },
  TAXONOMY_BATCH_TAGGING: {
    path: "/admin/taxonomy/batch-tagging",
    icon: SvgTag,
    title: "Batch Tagging",
    sidebarLabel: "Batch Tagging",
  },
  TAXONOMY_QUERY_MATCH: {
    path: "/admin/taxonomy/query-match",
    icon: SvgSearch,
    title: "Query Match",
    sidebarLabel: "Query Match",
  },
  AGENTS: {
    path: "/admin/agents",
    icon: SvgOnyxOctagon,
