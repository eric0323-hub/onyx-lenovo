...
function NumericSettingField({
  ...
  const initial = valueProp == null ? "" : String(valueProp);
  ...
  const handleBlur = () => {
    ...
    const normalized = integer ? String(Math.round(parsed)) : String(parsed);
    setValue(normalized);
    if (normalized !== savedValue.current) {
      void saveSettings({ [name]: integer ? Math.round(parsed) : parsed });
      ...
      <SettingsLayouts.Root>
        ...
        <SettingsLayouts.Body>
          ...
          <Section gap={1}>
            ...
            >
              <InputTextArea
                placeholder="Describe your team and how LKnow should behave."
                rows={4}
                maxRows={10}
                autoResize
                  ...
                  <Section>
                    ...
                    >
                      <InputHorizontal
                        ...
                        description="Specify how long LKnow should retain chats in your organization."
                        tag={
                          !enterpriseTier
                            ? {
