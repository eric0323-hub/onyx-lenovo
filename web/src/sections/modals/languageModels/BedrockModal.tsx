    ...
    <>
      <InputPadder>
        <Section gap={1}>
          ...
          <InputVertical
            ...
            subDescription="Choose how LKnow should authenticate with Bedrock."
          >
      ...
      {authMethod === AUTH_METHOD_IAM && (
        <InputPadder>
          <MessageCard
            variant="info"
            title="LKnow will use the IAM role attached to the environment it’s running in to authenticate."
          />
        </InputPadder>
      )}
