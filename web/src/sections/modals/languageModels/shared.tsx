...
/**
 * Sentence appended to an API Base URL `subDescription` when LKnow is detected
 * to be running inside a container — explains why the default uses
 * `host.docker.internal`.
 */
export const CONTAINERIZED_HOST_NOTE =
  "With LKnow running in a container, `host.docker.internal` acts like `localhost` inside the container.";
